...
@Component({
  selector: 'app-stock-observation',
  templateUrl: './stock-observation.component.html',
  styleUrls: ['./stock-observation.component.scss'],
  providers:[
    StockService,
    ToastService,
    AlertService
...
export class StockObservationComponent implements OnInit {
